					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a class="main-slider-slide" href="#">
								<img src="./assets/img/main-slider/img-slider-2/1.jpg" alt=""
								     class="img-fluid">
							</a>
						</div>
						<div class="carousel-item">
							<a class="main-slider-slide" href="#">
								<img src="./assets/img/main-slider/img-slider-2/2.jpg" alt=""
								     class="img-fluid">
							</a>
						</div>
						<div class="carousel-item">
							<a class="main-slider-slide" href="#">
								<img src="./assets/img/main-slider/img-slider-2/3.jpg" alt=""
								     class="img-fluid">
							</a>
						</div>
						<div class="carousel-item">
							<a class="main-slider-slide" href="#">
								<img src="./assets/img/main-slider/img-slider-2/4.jpg" alt=""
								     class="img-fluid">
							</a>
						</div>
						<div class="carousel-item">
							<a class="main-slider-slide" href="#">
								<img src="./assets/img/main-slider/img-slider-2/5.jpg" alt=""
								     class="img-fluid">
							</a>
						</div>
						<div class="carousel-item">
							<a class="main-slider-slide" href="#">
								<img src="./assets/img/main-slider/img-slider-2/6.jpg" alt=""
								     class="img-fluid">
							</a>
						</div>
						<div class="carousel-item">
							<a class="main-slider-slide" href="#">
								<img src="./assets/img/main-slider/img-slider-2/7.jpg" alt=""
								     class="img-fluid">
							</a>
						</div>
					</div>
